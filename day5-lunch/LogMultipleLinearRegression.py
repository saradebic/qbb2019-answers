...
"""Usage: ./LogMultipleLinearRegression.py <t_data.ctab> <H3K4me1_tab> <H3K4me3_tab> <H3K9me3_tab>""" #outtab is a file with histone data
...
fig, ax = plt.subplots()
ax.hist(ols_results.resid, bins=10000, range=(-100,100))
ax.set_xlim((-10,10))
